...
function testButtonNames(Component: React.FC, name: string) {
  test(`${name} buttons have accessible names`, async () => {
    if (name === 'TrendReviewBoard') {
      ...
      const trend: Trend = { id: 't-1', name: 'Trend', summary: 'Summary', status: 'candidate', horizon: '12-24 months', likelihoodScore: 0, confidenceScore: 0, impactScore: 0, maturityStage: 'emerging', relatedSignalIds: [], drivers: [], blockers: [], whatNeedsToBeTrue: [], leadingIndicators: [], monitoringQuestions: [], recommendedActions: [], createdAt: '', updatedAt: '' };
